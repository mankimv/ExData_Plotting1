...
with(feb_gap_fr, plot(DateTime, Voltage,
                      xlab="datetime", type="l"))#xlab="datetime" as my var is called DateTime
...
with(feb_gap_fr, plot(DateTime, Global_reactive_power,
                      xlab="datetime", type="l"))#xlab="datetime" as my var is called DateTime
dev.off()